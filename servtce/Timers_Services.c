...
{
	if (freq!=0)// here it has to be critical section because there could be interrupts while it writing in ICR1
	{
...
void PWM_Duty(u8 duty) // in percentage forum 
{
	 if (duty<=100)// here it has to be critical section because there could be interrupts while it writing in OCR1A
	{
...
static u8 volatile f2(u32* Pfreq,u8* Pduty)
{
	u16 Ton,Toff;
